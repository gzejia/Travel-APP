...
class SalesNav extends StatelessWidget {
  ...
  const SalesNav({Key key, @required this.salesBox, this.name = 'nav'})
      : super(key: key);
  ...
  Widget _topMore(BuildContext context) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: <Widget>[
        Image.network(salesBox.icon, height: 15, fit: BoxFit.fill),
        Container(
            padding: EdgeInsets.fromLTRB(10, 1, 8, 3),
            ...
            child: GestureDetector(
              onTap: () {
                Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            WebViewPage(url: salesBox.moreUrl, title: '更多活动')));
              },
              child: Text(
                '获取更多福利 >',
